    ...
    <>
      <div className="president-container">
        ...
        <ul className="president-points">
            ...
            <li>Planning to increase oversight across HackED and fully integrating it into the club by adding clauses in the constitution requiring full transparency and approval for all financial decisions.</li>
