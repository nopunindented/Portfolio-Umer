  ...
  return (
    <>
      <div className={`voltscript-container ${isHovered ? 'hovered' : ''}`} onMouseEnter={handleHover} onMouseLeave={handleMouseLeave}>
        ...
        <div className="thriftaid-logo" style={{ display: "flex", flexDirection: "row", alignItems: "center", fontFamily: "Verdana", fontSize: "300%", color: "rgb(33, 181, 222)", position: "relative" }}>
        ...
        <div className="thriftaidrow-three">
          ...
          VoltScript is meant to be a VS Code extension mean to calculate the cost of the electricity from running code. The ideal use case for this project would be for LLM (AI) queries run on your CPU.
          </div>
